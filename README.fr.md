...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/langues-6-9b59b6" alt="6 langues">
</p>

<p align="center">
  <img src="docs/fr/hero.png" alt="Une enquête ouverte dans osint-canvas : un nom au centre, et les trouvailles reliées autour" width="100%">
</p>
...
<p align="center"><img src="docs/fr/creation.png" alt="Création rapide : un lien GitHub collé, détecté comme compte social" width="620"></p>
...
<p align="center"><img src="docs/fr/lien.png" alt="Le panneau d'un lien : ce qu'il dit, comment il a été trouvé, sa fiabilité" width="760"></p>
...
<p align="center"><img src="docs/fr/outils.png" alt="Le panneau d'un élément et les outils filtrés pour son type" width="760"></p>
...
<p align="center"><img src="docs/fr/historique.png" alt="La liste des enquêtes et la frise des versions" width="300"></p>

### Exporter

<img src="docs/fr/rapport.png" alt="Le rapport imprimable généré depuis le plan" width="380" align="right">
...
L'interface existe en **français, anglais, espagnol, portugais, italien et allemand** — y compris
les 17 types d'éléments, leurs champs, les catégories d'outils et les rapports exportés. Le
sélecteur est en bas de la colonne de gauche ; la langue du navigateur est prise par défaut au
premier lancement, et votre choix est retenu ensuite.

Vos données ne sont jamais traduites : ce que vous écrivez reste tel quel.

<p align="center"><img src="docs/langues.png" alt="La palette d'éléments en anglais" width="290"></p>

### Thème clair

<p align="center"><img src="docs/fr/theme-clair.png" alt="Le même plan en thème clair" width="100%"></p>
...
`src/lib/tools.ts`, de nouvelles plateformes dans `src/lib/platforms.ts`, et de nouvelles langues.

**Ajouter une langue** : copiez `src/i18n/fr.ts`, traduisez, et déclarez-la dans
`src/i18n/langs.ts` et `src/i18n/current.ts`. Le dictionnaire français sert de type de référence,
donc `npx tsc --noEmit` refuse une traduction à laquelle il manque une clé — vous ne pouvez pas
en oublier une. Avant d'ouvrir une PR, cette commande doit passer.
